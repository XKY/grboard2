	...
	<div class="container">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="text" name="db_hostname" required="true" class="form-control" maxlength="30" value="localhost" /> 
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="text" name="db_username" placeholder="DB 계정 아이디 입력" required="true" class="form-control" maxlength="30" value="" /> 
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="password" name="db_password" placeholder="DB 계정 비밀번호 입력" required="true" class="form-control" maxlength="30" value="" /> 
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" name="db_prefix_board" required="true" class="form-control" maxlength="30" value="gr_" /> 
				</div>
				<div class="col-md-2">
					<input type="text" name="db_prefix_blog" required="true" class="form-control" maxlength="30" value="gbl_" /> 
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-2">
					<input type="text" name="admin_id" placeholder="관리자 ID 지정" required="true" class="form-control" maxlength="30" value="admin" /> 
				</div>
				<div class="col-md-2">
					<input type="password" name="admin_pw" placeholder="관리자 비밀번호 지정" required="true" class="form-control" maxlength="30" value="" /> 
				</div>
